...
class TestNoteCreation(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.form_data = {'text': cls.NOTE_TEXT,
                         'title': cls.NOTE_TEXT, 'slug': cls.NOTE_SLUG}
    ...
    def test_not_unique_slug(self):
        note = Note.objects.create(
            title='Заголовок', text=self.OTHER_NOTE_TEXT,
            slug=self.NOTE_SLUG, author=self.user
        )
...
class TestNoteEditDelete(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.form_data = {'text': cls.NEW_NOTE_TEXT,
                         'title': cls.NEW_NOTE_TITLE, 'slug': cls.note.slug}
